 ...
 * @method \App\Model\Entity\Curso findOrCreate($search, callable $callback = null)
 *
...
class CursosTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('idCurso')
            ->allowEmpty('idCurso', 'create');

        $validator
            ->allowEmpty('Curso_nome');

        $validator
            ->allowEmpty('Curso_Coordenador');
