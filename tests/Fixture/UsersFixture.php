...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'idusers' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        '_indexes' => [
            'fk_user_alunos1_idx' => ['type' => 'index', 'columns' => ['alunos_idAluno'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['idusers'], 'length' => []],
