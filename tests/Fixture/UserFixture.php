...
class UserFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_user_alunos1_idx' => ['type' => 'index', 'columns' => ['alunos_idAluno'], 'length' => []],
        ],
        '_constraints' => [
            'fk_user_alunos1' => ['type' => 'foreign', 'columns' => ['alunos_idAluno'], 'references' => ['alunos', 'idAluno'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
